    ...
    describe('Reports', function() {
        ...
        describe('Report Creation and Flow', function() {
            describe('Single runner', function() {
                ...
                it('Post full cycle stats and verify report assertions', async function () {
                    const jobName = 'jobName';
                    const id = uuid.v4();
                    const runnerId = uuid.v4();
                    ...
                    // expect(getReportResponse.body).to.have.property('avg_rps').and.to.be.equal(1184.24);

                    // expect(getReportResponse2.body).to.have.property('avg_rps').and.to.be.equal(20);

                    // expect(getReportResponse3.body).to.have.property('avg_rps').and.to.be.equal(13.33);
                ...
                it('should fetch a report successfully with failed after a runner posted error stats', async function () {
                    const jobName = 'jobName';
                    const id = uuid.v4();
                    const runnerId = uuid.v4();
